def solution(N, number):
    ...
    #    n(1)?n(2) == n(2)?n(1), where ?==+,*
    # 4, n(1)?n(3) + n(2)?n(2) + n(3)?n(1) + {NNNN} as n(4)
    #    n(1)?n(3) == n(3)?n(1), where ?==+,*
    # n, ....
    ...
    # ex) 테스트 케이스 : 5 + 5 + (5/5) + (5/5) 같은 경우는 n(6)에 속하는 원소인데
    # (5) + (5) + (5/5) + (5/5) 라 생각하면
    # 5는 n(1)의 원소에 해당하고 (5/5)는 n(2)의 원소에 해당한다
    # ((5)+(5))는 n(1)?n(1)의 연산 결과 n(2)중 하나이며
    # ((5/5)+(5/5))의 경우도 n(2)?n(2)의 연산결과 n(4) 중 하나이다
    # 결국, ( ( (5) + (5) ) + ( (5/5) + (5/5) ) )는 n(2)?n(4)의 연산결과 중 하나이다.


    # N은 8개까지만 사용 가능
    for i in range(2,9):
        # N을 i개 사용하였을때 만들 수 있는 수들 집합 S[i]
